{
  mode: 'production',
  context: 'C:\\Users\\Paulo\\Vue\\build-a-bot',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    dgram: 'empty',
  ...
  output: {
    path: 'C:\\Users\\Paulo\\Vue\\build-a-bot\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\Users\\Paulo\\Vue\\build-a-bot\\src',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'C:\\Users\\Paulo\\Vue\\build-a-bot\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '74e420d2'
            }
          },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: 'C:\\Users\\Paulo\\Vue\\build-a-bot\\node_modules\\mini-css-extract-plugin\\dist\\loader.js',
                options: {
                  hmr: false,
                  publicPath: '../'
                }
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '0377ad42',
              emitWarning: true,
              emitError: false,
              eslintPath: 'C:\\Users\\Paulo\\Vue\\build-a-bot\\node_modules\\eslint',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\Users\\Paulo\\Vue\\build-a-bot\\public\\index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'C:\\Users\\Paulo\\Vue\\build-a-bot\\public',
          to: 'C:\\Users\\Paulo\\Vue\\build-a-bot\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
